...
// See corresponding header file 'cadical.h' (!) for more information.
//
// Again, to avoid confusion, note that, 'cadical.h' is the header file of
// this file 'solver.cpp', since we want to call the application and main
// file 'cadical.cpp', while at the same time using 'cadical.h' as the
// main header file of the library (and not 'solver.h').
