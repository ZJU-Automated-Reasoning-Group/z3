...
static tactic * mk_pp_qfbv_tactic(ast_manager& m, params_ref const & p, tactic* sat) {
    ...
    tactic * st = main_p(and_then(preamble_st,
				      ...
				      the UFs can be eliminated by eager ackermannization in the preamble.
                                  */
                                  ...
                                  /*
                                  rainoftime: disable `qfbv_eq_probe` and use a uniform stragety for solving QF_BV formulas
